(() => {
  ...
  window.cnmiSupabaseApi={call,client:()=>init(),getDonorHistory,getDonorHistories,importSnapshot,getHistorySummary,searchDonors,resolveDonorIds,createBagRange,getBagBatchStatus,startRealtime};
})();
