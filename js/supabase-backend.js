(() => {
  ...
  window.cnmiSupabaseApi={call,client:()=>init(),getDonorHistory,getDonorHistories,importSnapshot,getHistorySummary,searchDonors,searchDonorsAdvanced,resolveDonorIds,createBagRange,getBagBatchStatus,startRealtime};
})();
